...
import com.example.socialnetworkfx.guiUser.LogInPage;
...
public class SocialNetworkUser extends Application {
    String url;
    String username;
    String password;
    ...
    public void initView(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(SocialNetworkAplication.class.getResource("userPages/logInPage.fxml"));
        stage.setScene(new Scene(fxmlLoader.load()));
        LogInPage logInPageController = fxmlLoader.getController();
        logInPageController.setUp(userService, friendshipService, networkService, groupChatService,stage);
    }
